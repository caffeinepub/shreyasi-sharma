...
export class Backend implements backendInterface {
    ...
    async addAward(arg0: string, arg1: bigint, arg2: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addAward(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addProject(arg0: string, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAwards(): Promise<Array<Award>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAwards();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBio(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getBio();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPortfolioByName(arg0: string): Promise<Portfolio> {
        if (this.processError) {
            try {
                const result = await this.actor.getPortfolioByName(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initializePortfolios(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializePortfolios();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
